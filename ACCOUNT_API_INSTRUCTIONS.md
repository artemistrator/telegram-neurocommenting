...
## ШАГ 1: Обновить импорты (строки 6-15)
...
## ШАГ 2: Добавить AccountManager instance (после строки 29)
...
## ШАГ 3: Добавить API endpoints (после строки 642, перед @app.post("/api/telegram/logout"))
...
## ИТОГО: 3 изменения в main.py

1. Строка 6: добавить UploadFile, File, Form в импорты FastAPI
2. Строка 15: добавить `from account_manager import AccountManager`
3. Строка 30: добавить `account_mgr = AccountManager()`
4. Строка 643: вставить все 7 API endpoints (весь блок выше)
